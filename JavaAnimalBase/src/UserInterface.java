...
public class UserInterface {
  ...
  private void delete() {
    ...
    if (success) System.out.println("The animal with name '" + name + "' has been deleted");
    else System.out.println("Animal with name '" + name + "' does not exist, and cannot be deleted");
  }
  
  private void load() {
    System.out.println("Loading the database ...");
    
    boolean loaded = application.loadDatabase();
    
    if (loaded) System.out.println("Done!");
    else System.out.println("Cannot load");
  }
  
  private void save() {
    System.out.println("Saving the database ...");
    boolean saved = application.saveDatabase();
    if (saved) {
